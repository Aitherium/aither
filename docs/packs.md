...
| **[GobboPack](packs/gobbonet.md)** | `3.3.0` | [gobbonet-3.3.0.tar.gz](https://github.com/Aitherium/aither-adk/releases/download/v3.3.0/gobbonet-3.3.0.tar.gz) | 23.3 KB | GobboNet Companion — an agent harness for a local-first chat client |
